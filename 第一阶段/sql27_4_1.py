...
def insert_product_data(dataJson, connection):
    with connection.cursor() as cursor:
        ...
        insert_data_into_table(cursor, "Product_FabDescription", "FAB产品解说", dataJson['FAB 产品解说'], CardId)
...
def main():
    ...
    try:
            with open(filePath, 'r', encoding='utf-8') as file:
                    ...
                    for i in dataJson:
                        insert_product_data(i, connection)
